...
//  /home/meyzjcmc/public_html/tikelu.cl/wp-content/maintenance/template.phtml
...
<head>
    ...
    <link rel="stylesheet" href="http://tikelu.cl/wp-content/maintenance/assets/styles.css">
    <script src="http://tikelu.cl/wp-content/maintenance/assets/timer.js"></script>
...
<body>
    ...
    <section class="social-links">
                ...
                <span class="icon"><img src="http://tikelu.cl/wp-content/maintenance/assets/images/facebook.svg" alt="Facebook"></span>
            </a>
                    <a class="social-links__link" href="https://twitter.com/cPanel" target="_blank" title="Twitter">
                <span class="icon"><img src="http://tikelu.cl/wp-content/maintenance/assets/images/twitter.svg" alt="Twitter"></span>
            </a>
                    <a class="social-links__link" href="https://instagram.com/cPanel" target="_blank" title="Instagram">
                <span class="icon"><img src="http://tikelu.cl/wp-content/maintenance/assets/images/instagram.svg" alt="Instagram"></span>
            </a>
            </section>
