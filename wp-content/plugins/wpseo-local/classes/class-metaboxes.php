...
if ( ! class_exists( 'WPSEO_Local_Metaboxes' ) ) {
	...
	class WPSEO_Local_Metaboxes {
		...
		function metabox_locations() {
			...
			echo '<p class="yoast-local-seo-field-desc">' . sprintf( __( 'If your business type is not listed, please read %sthe FAQ entry%s.', 'yoast-local-seo' ), '<a href="http://kb.yoast.com/article/49-my-business-is-not-listed-can-you-add-it" target="_blank">', '</a>' ) . '</p>';
			...
			foreach ( $wpseo_local_core->days as $key => $day ) {
				...
				echo '<div class="clear opening-hours-second ' . ( ( false === $multiple_opening_hours ) ? 'hidden' : '' ) . '">';
            ...
            <div id="wpseo_add_map" style="display:none;">
                <div class="wrap">
                    <div>
                        ...
                        <div style="padding:15px 15px 0 15px;">
                            <label class="wpseo-for-textfield" for="wpseo_map_width"><?php esc_html_e( 'Width:', 'yoast-local-seo' ); ?></label> <input type="text" id="wpseo_map_width" class="wpseo-textfield" value="400"><br>
                            <label class="wpseo-for-textfield" for="wpseo_map_height"><?php esc_html_e( 'Height:', 'yoast-local-seo' ); ?></label> <input type="text" id="wpseo_map_height" class="wpseo-textfield" value="300"><br>
							...
							<?php if ( wpseo_has_multiple_locations() ) { ?>
                                ...
                                <label for="wpseo_map_marker_clustering"><?php _e( 'Marker clustering', 'yoast-local-seo' ); ?></label><br>
							<?php } ?>
							...
							<?php if ( ! wpseo_has_multiple_locations() ) { ?>
                                ...
                                <label for="wpseo_map_show_category_filter"><?php _e( 'Show a filter for location categories under the map', 'yoast-local-seo' ); ?></label><br>
							<?php } ?>
                        </div>
                    ...
                    <div class="wrap">
                        <div>
                            ...
                            <div style="padding:0 15px 0 15px;">
                                ...
                                <label for="wpseo_sl_show_category_filter"><input type="checkbox" id="wpseo_sl_show_category_filter"/> <?php _e( 'Show category filter under the map', 'yoast-local-seo' ); ?>
                                </label><br>
                            </div>
                            <div style="padding:15px;">
		...
		function enqueue_scripts() {
			...
			wp_enqueue_script( 'wp-seo-local-seo', plugins_url( '../js/wp-seo-local-plugin-350' . WPSEO_CSSJS_SUFFIX . '.js', __FILE__ ), array(), WPSEO_VERSION, true );
